...
SERVER_PATH = "/Users/kalavathi/Downloads/agentic demo/gen-ai-rag/code/src/main.py"
EXPECTED_TOOLS = [
    "get_customer_info",
    "get_order_details",
    "check_inventory",
...
async def test_mcp_server_connection():
    ...
    server_params = StdioServerParameters(
        command="/Users/kalavathi/Downloads/agentic demo/.venv/bin/python", args=[SERVER_PATH], env=None
    )
